...
def map_perm_row(row, fy, sf):
    return {
        ...
        "employer_name":           coerce_str(g(row, "EMP_BUSINESS_NAME", "EMPLOYER_NAME")),
        "employer_state":          coerce_str(g(row, "EMP_STATE", "EMPLOYER_STATE_PROVINCE")),
        "employer_city":           coerce_str(g(row, "EMP_CITY", "EMPLOYER_CITY")),
        "employer_postal_code":    coerce_str(g(row, "EMP_POSTCODE", "EMPLOYER_POSTAL_CODE")),
        "employer_fein":           coerce_str(g(row, "EMP_FEIN", "EMPLOYER_FEIN")),
        "employer_naics":          coerce_str(g(row, "EMP_NAICS", "NAICS_CODE")),
        "employer_num_payroll":    coerce_int(g(row, "EMP_NUM_PAYROLL", "EMPLOYER_NUM_EMPLOYEES")),
        "employer_year_commenced": coerce_int(g(row, "EMP_YEAR_COMMENCED", "EMP_YEAR_COMMENCED_BUSINESS", "EMPLOYER_YEAR_COMMENCED_BUSINESS")),
        "atty_law_firm":           coerce_str(g(row, "ATTY_AG_LAW_FIRM_NAME", "AGENT_ATTORNEY_FIRM_NAME")),
        "atty_last_name":          coerce_str(g(row, "ATTY_AG_LAST_NAME", "AGENT_ATTORNEY_NAME")),  # legacy holds full name
        "atty_first_name":         coerce_str(g(row, "ATTY_AG_FIRST_NAME")),
        "atty_state":              coerce_str(g(row, "ATTY_AG_STATE", "AGENT_ATTORNEY_STATE_PROVINCE")),
        "job_title":               coerce_str(g(row, "JOB_TITLE")),
        "soc_code":                coerce_str(g(row, "PWD_SOC_CODE", "PW_SOC_CODE")),
        "soc_title":               coerce_str(g(row, "PWD_SOC_TITLE", "PW_SOC_TITLE")),
        "wage_from":               coerce_num(g(row, "JOB_OPP_WAGE_FROM", "WAGE_OFFER_FROM")),
        "wage_to":                 coerce_num(g(row, "JOB_OPP_WAGE_TO", "WAGE_OFFER_TO")),
        "wage_per":                coerce_str(g(row, "JOB_OPP_WAGE_PER", "WAGE_OFFER_UNIT_OF_PAY")),
        "worksite_city":           coerce_str(g(row, "PRIMARY_WORKSITE_CITY", "WORKSITE_CITY")),
        "worksite_state":          coerce_str(g(row, "PRIMARY_WORKSITE_STATE", "WORKSITE_STATE")),
        "worksite_postal_code":    coerce_str(g(row, "PRIMARY_WORKSITE_POSTAL_CODE", "WORKSITE_POSTAL_CODE")),
        "worksite_bls_area":       coerce_str(g(row, "PRIMARY_WORKSITE_BLS_AREA")),
        "pwd_number":              coerce_str(g(row, "JOB_OPP_PWD_NUMBER", "PW_TRACK_NUMBER")),
